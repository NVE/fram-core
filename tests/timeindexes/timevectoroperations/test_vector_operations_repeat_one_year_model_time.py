...
from framcore.timeindexes._time_vector_operations import repeat_oneyear_modeltime
...
def test_when_output_end_date_is_before_or_equal_to_output_start_date_should_raise_exception(start_date: dt.datetime, end_date: dt.datetime):
    input_vector = np.arange(52, dtype=np.float32)
    input_start_date = dt.datetime.fromisocalendar(2020, 1, 1)
    output_start_date = dt.datetime.fromisocalendar(2021, 1, 1)
